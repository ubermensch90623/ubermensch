...
### Q7. **P9 30문항 처분 (만장일치 GATED · P11 ORANGE 경보)** 🆕 2026-04-18 18:30
> 4자 만장일치 GATED (P6·SC1·SC2·P11). 세부 판결 → `docs/gyeongyeon/2026-04-18_P9_disposition.md`
- (A) **전면 격리 + 기본서 전환 (P11 권장, Recommended)** — UI 경고, DrillSession 차단, D-21 주력은 정병열·해커스·공준모
- (B) mid 7건만 힌트 전환 (비권장 — SC2 corpus embed HIGH · 정답키 자기수정 P9-001 포함)
- (C) G2 재편 (P9 후속 세대, 5/9 이후 1차 기출 확보 시 착수)

### Q8. **학습자료 주력 전환 (SC2 대안A)** 🆕
> SC2 북극성 기여 분석: P9 수정 3일 투입 vs 종환 보유 기본서 2-3회독 → 후자 승
- (A) **기본서 2-3회독 전환 (SC2·SC1 공통 권장)** — 정병열 경제학 + 해커스 NCS 2026 + 공준모 후기
- (B) 혼합 — 기본서 60% + P9 참고 40%
- (C) 현행 유지 (비권장 — 북극성 2/10 리스크)
